...
const CourseNotFound = () => {
    return(
        <div className="flex flex-col items-center justify-center min-h-screen  px-4 text-center">
            ...
            <h1 className="font-bold text-2xl md:text-4xl text-gray-800 dark:text-gray-100  ">
                Course not found.
            </h1>
...
const CourseSkeleton = () => {
    return(
       <div className="flex-1 flex flex-col md:flex-row justify between items-start md:items-center px-4 py-2 gap-4 "> 
